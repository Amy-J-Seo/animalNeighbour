                         ...
                         <div class="p-5" align="center">
                           ...
                           <%--   <input type="hidden" id="mId" name="mId" value="${session.mId }"> --%>
                             ...
                             <hr>
                                ...
                                <hr>
                                 <div class="form-group">
                                     <input type="text" class="form-control form-control-user" id="fhNeed" name="fhNeed"
                                         placeholder="어떻게 도움을 받고 싶은지 조금더 알려주세요. 예) 동네, 근교만. 반려가족인 경우만 등..">
                                 </div>
                                
                                 <div class="form-group">
                                     <textarea class="form-control" rows="13" id="fhHow"
                                         name="fhHow" placeholder="상세하게 알려 주세요~!" required></textarea>
                                 </div>
