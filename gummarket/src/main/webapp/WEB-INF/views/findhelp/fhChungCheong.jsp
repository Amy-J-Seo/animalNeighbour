...
<body id="page-top">
   ...
   <div class="continer my-auto pb-3">
      ...
      <div class="continer text-center">
		...
		<a href="findChungCheong.do" style="text-decoration: none; color: rgb(255, 190, 83); font-weight: 600;">충 청</a>&nbsp;|&nbsp;
                   ...
                   <div class="card h-100">
                       ...
                       <div class="card-body p-4 ">
                           <div class="text-left">
                              ...
                              <i class="fas fa-paw"></i> 지 역 : ${item.address }<br>
