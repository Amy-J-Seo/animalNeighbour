                 ...
                 <div class="row">
                     ...
                     <div class="col-lg-12">
                         <div class="p-5" align="center">
                             ...
                             <br>
                             <!-- form start -->
                             <form class="user" id="frm" name="frm" action="ohItemUpdateForm.do" method="post">
                             <input type="hidden" id="ohNo" name="ohNo" value="${itemToUpdate.ohNo}">
                           ...
                           <input type="hidden" id="mId" name="mId" value="${session.mId }">
                             ...
                             <hr>
                                 <div class="form-group">
                                     ...
                                     id="ohTitle" name="ohTitle" value="${itemToUpdate.ohTitle }" required >
                                 </div>
                                 ...
                                 <hr>
                                     ...
                                     id="mId" name="mId" value="${itemToUpdate.mId }" readonly>
                                 </div>
                                ...
                                <hr>
                                 <div class="form-group">
                                     <textarea class="form-control" rows="13" id="ohDetails"
                                         name="ohDetails" placeholder="${itemToUpdate.ohDetails }" required></textarea>
                                 </div>
